...
export default class AboutStats extends Component {
  ...
  render () {
    ...
    const katherine = {'name': 'Katherine Bruton', 'title': 'Back-End Engineer', 'text': "I'm a senior from San Antonio, TX. I love exploring cities, playing video games, and swing dancing! I worked on the database, API, and unit tests.", 'commits': katherinec, 'issues': 16, 'tests': 34, imageSrc: katherineImg, imageCaption: 'Katherine'};
