...
export default class AboutStats extends Component {
    ...
    const katherine = {"name": "Katherine Bruton", "title": "Back-End Engineer", "text": "I'm a senior from San Antonio, TX. I love exploring cities, playing video games, and swing dancing! For this phase of the project, I worked on scraping data and inserting it into our database. I also helped out with the front-end and API when I could.", "commits": this.state.katherinec.length, "issues": 8, "tests": 4, imageSrc: katherineImg, imageCaption: "Katherine"};
    ...
    const rachel = {"name": "Rachel Oei", "title": "Back-End Engineer", "text": "I am a senior computer science major from Miami, Florida. I worked on the Home and About pages for this project and got to learn about Google Cloud Platform, Flask, and Bootstrap.", "commits": this.state.rachelc.length, "issues": 13, "tests": 17, "imageSrc": rachelImg, "imageCaption": "Rachel"};
